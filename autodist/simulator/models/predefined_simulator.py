...
from models.base import SimulatorBase
from utils import resolved_devices_on_diff_machine, get_sparse_var_bits, get_dense_var_bits
...
class PredefinedSimulator(SimulatorBase):
	...
	def simulate(self, strategy: Strategy, resource_spec: ResourceSpec, checkpoint=None):
		...
		inputs = self.create_features(strategy, resource_spec, cluster, device_resolver)
		with context.eager_mode():
	...
	def create_features_v0(self, strategy: Strategy, resource_spec: ResourceSpec, cluster: SSHCluster,
